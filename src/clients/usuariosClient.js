function listarUsuarios() {
  ...
  fetch("http://localhost:3000/usuarios")
    ...
    .then(function (data) {
      ...
      tabela.className = 'w-full border-collapse border border-slate-300'
      tabela.innerHTML = `
        <thead>
          <tr class="bg-gray-100">
            <th class="border border-slate-400 p-2">ID</th>
            <th class="border border-slate-400">Nome</th>
            <th class="border border-slate-400">Nome de Usuário</th>
            <th class="border border-slate-400">E-mail</th>
            <th class="border border-slate-400">Perfil</th>
