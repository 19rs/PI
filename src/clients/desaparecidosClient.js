...
async function renderItem(id) {
  ...
  modal.innerHTML = `
    <div class=' grid grid-cols-2 w-[80vw] h-[80vh]   overflow-hidden '>
      ...
      <div class='flex flex-col items-center justify-center bg-zinc-100 relative'>
              ...
              <div class='grid grid-cols-2 items-start  p-3'>
                  ...
                  <div class=' flex items-center justify-center  '> 
                      <dl class="-my-3 divide-y  divide-zinc-500 text-md    ">
                          ...
                          <img src='../assets/icon/whatsapp.png' class='size-12 border-2 rounded-lg border-black  cursor-pointer' onclick='compartilharPDF(${pessoa.id})'  />
                          </div>
                      </dl>
                  </div>
